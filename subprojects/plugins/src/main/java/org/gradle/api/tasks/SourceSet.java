...
public interface SourceSet extends ExtensionAware {
   ...
   /**
     ...
     * @deprecated Use {@link #getImplementationConfigurationName()}, {@link #getApiConfigurationName()}, {@link #getCompileClasspathConfigurationName()} or {@link #getApiElementsConfigurationName()} instead depending on the use case.
     */
    @Deprecated
     ...
     * @deprecated Use {@link #getRuntimeOnlyConfigurationName()}, {@link #getRuntimeClasspathConfigurationName()} or {@link #getRuntimeElementsConfigurationName()} instead depending on the use case.
     */
    @Deprecated
